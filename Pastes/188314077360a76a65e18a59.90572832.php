...
</div></textarea></div>Edit<input type='checkbox' id='Checkbox'  onclick='mySwitch()'><input type='submit' class='submit' id='submit' name='submit' value='Apply changes' style='display: none'/><script src="../controller/scripts/syntaxHighlightC.js"></script>