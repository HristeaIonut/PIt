...
</div></textarea>Edit<input type='checkbox' id='Checkbox'  onclick='mySwitch()'><input type='submit' class='submit' id='submit' name='submit' value='Apply changes' style='display: none'/></div><script src="../controller/scripts/syntaxHighlightHTML.js"></script>