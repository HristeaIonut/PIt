...
<div class='textarea-container'><pre><code id='cod'>int x = 10;
string s = "pere";</code></pre><form method='post' action='../controller/editCode.php'><textarea name='codeArea' id='edit' class='textarea' style='display: none'>int x = 10;
