...
<div class='modified-pastes'>Other Versions<table id='modified-pastes'></table></div><div class='textarea-container'><pre><code id='cod'>adfadfdfdf</code></pre><form method='post' action='../controller/editCode.php'><textarea name='codeArea' id='edit' class='textarea' style='display: none'>adfadfdfdf</textarea><div id='checkbox-div'>Edit<input type='checkbox' id='Checkbox'  onclick='mySwitch()'></div><input type='hidden' name='fileName' value="<?php echo basename(__FILE__)?>"/><input type='submit' class='submit' id='submit' name='submit' value='Apply changes' style='display: none'/></form></div><button type="button" class="contact" onclick="deletePaste()">Delete</button><script type = "text/JavaScript">
