...
<div class='textarea-container'><pre><code id='cod'>int x = 15;
string s = "fruncte";</code></pre><form method='post' action='../controller/editCode.php'><textarea name='codeArea' id='edit' class='textarea' style='display: none'>int x = 15;
string s = "fruncte";</textarea><div id='checkbox-div'>Edit<input type='checkbox' id='Checkbox'  onclick='mySwitch()'></div><input type='hidden' name='fileName' value="<?php echo basename(__FILE__)?>"/><input type='hidden' name='script' value='<script src="../controller/scripts/syntaxHighlightC.js"></script>'/><input type='submit' class='submit' id='submit' name='submit' value='Apply changes' style='display: none'/></form></div><script type = "text/JavaScript">
